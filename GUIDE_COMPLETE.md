...
Before using axia-secure-validator you need to have installed:
...
for details or [create an issue](https://github.com/axia-tech/axia-secure-validator/issues/new) for
...
accounts in all of them, see [here](https://github.com/axia-tech/axia-secure-validator/blob/master/config/main.sample.json)
...
"validators": {
    ...
    "dbSnapshot": {
      "url": "https://axct-rocksdb.axcshots.io/axctest-6658753.RocksDb.7z",
